...
function activate(context) {
    ...
    const clientOptions = {
        ...
        synchronize: {
            ...
            fileEvents: vscode_1.workspace.createFileSystemWatcher('**/*.zz'),
        },
    };
    // Create and start the client
    client = new node_1.LanguageClient('zzLanguageServer', 'ZZ Language Server', serverOptions, clientOptions);
